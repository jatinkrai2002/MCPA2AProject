...
if __name__ == "__main__":
    ...
    print("IssueCount:", loader.IssueCount())
    print("NearMissCount:", loader.NearMissCount())
    print("OpenIssueCount:", loader.OpenIssueCount())
    print("HighPriorityIssueCount:", loader.HighPriorityIssueCount())
    print("NearMisstoIssueRatio:", loader.NearMisstoIssueRatio())
    print("AverageProcessingHours:", loader.AverageProcessingHours())
    print("TotalCostImpact:", loader.TotalCostImpact())
    print("ResolutionRate:", loader.ResolutionRate())
    print("CriticalIssueCount:", loader.CriticalIssueCount())
    print("AvgCustomerImpact:", loader.AvgCustomerImpact())
